...
@section('title', 'Edit Question - BiSignDo')
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-pink-700 mt-4">
                Modify your question and update it for the community.
            </p>
        </div>

        <!-- Back to My Questions Button -->
            ...
            <form action="{{ route('forum.update', $question->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="title" id="title" 
                        ...
                        placeholder="Enter your question title" value="{{ old('title', $question->title) }}" required>
                    @error('title')
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" id="content" rows="6" 
                        class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-pink-400 focus:outline-none" 
                        placeholder="Provide details for your question" required>{{ old('content', $question->content) }}</textarea>
                    @error('content')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
